...
extern "C"
{
     ...
     Java_com_paris8_univ_androidproject_engine_SkyBox_newSkyBox(JNIEnv *env, jobject thiz, Engine::ObjectHandler shaderProgramHandler)
     {
     ...
     JNI_RETURN(void)
     Java_com_paris8_univ_androidproject_engine_SkyBox_load(JNIEnv *env, jobject thiz, Engine::ObjectHandler objectHandler,
     ...
     JNI_RETURN(void)
     Java_com_paris8_univ_androidproject_engine_SkyBox_display(JNIEnv *env, jobject thiz, Engine::ObjectHandler objectHandler, Engine::ObjectHandler cameraObjectHandler)
     {
