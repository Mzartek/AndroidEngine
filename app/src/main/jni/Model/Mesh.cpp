...
{
     JNI_RETURN(void)
     Java_com_paris8_univ_androidproject_engine_model_Mesh_setMaterial(JNIEnv *env, jobject thiz,
								       Engine::ObjectHandler objectHandler,
								       Engine::ObjectHandler materialHandler)
     {
	  Engine::Material *material = Engine::Object::retrieveObject<Engine::Material>(materialHandler);
	  Engine::Object::retrieveObject<Engine::Mesh>(objectHandler)
	       ->setMaterial(std::shared_ptr<Engine::Material>(material, Engine::null_deleter));
     }
	
     JNI_RETURN(void)
     Java_com_paris8_univ_androidproject_engine_model_Mesh_display(JNIEnv *env, jobject thiz,
								   Engine::ObjectHandler objectHandler)
     {
	  Engine::Object::retrieveObject<Engine::Mesh>(objectHandler)->display();
     }
}
