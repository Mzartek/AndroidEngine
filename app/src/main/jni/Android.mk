...
LOCAL_SRC_FILES         := Object.cpp GraphicsRenderer.cpp Buffer.cpp ShaderProgram.cpp SkyBox.cpp Camera/Camera.cpp Camera/OrthoCamera.cpp Camera/PerspCamera.cpp Model/Material.cpp Model/Mesh.cpp Model/Static/StaticMesh.cpp Texture/Texture.cpp Texture/Texture2D.cpp Texture/TextureCube.cpp Tools/StringHandler.cpp
